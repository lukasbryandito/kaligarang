...
$tegangan = mysqli_query($koneksi, "SELECT teg FROM data order by id asc limit 30");
...
<li><a hr<li><a href="index6.php">keruh</a></li>
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            label: '',
			    data: [<?php while ($g = mysqli_fetch_array($tegangan)) { echo '"' . $g['teg'] . '",';}?>],
